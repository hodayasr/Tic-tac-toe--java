...
public Frame1()                                        //Tic tac default constructor which adds and dimensions Jframe
{
 super();
  ...
  for(int j = 0; j < 3; j++) 
    {
     ...
     buttons[i][j].setBackground(new Color(152, 251, 152));
...
{
  Frame1 game = new Frame1();         //main method and instantiating tic tac object and calling initialize function
  game.initialize();
 }
}
